...
MAX_FORCE = [50] * 12   # Max force for joints
up_stairs_x = 4         # Target
...
for target in joint_states:
    p.setJointMotorControlArray(quadruped, jointIndices = LEG_JOINT_NUMBERS, 
                                controlMode = p.POSITION_CONTROL, targetPositions = target,
                                forces = MAX_FORCE)
    p.stepSimulation()
